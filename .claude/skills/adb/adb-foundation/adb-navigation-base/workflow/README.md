# adb-navigation-base Workflows

Workflow infrastructure for Navigation and device state management

## Overview

This directory contains TOON-based workflow definitions for automating Navigation and device state management workflows. Each workflow pairs a `.toon` file (orchestration logic) with a `.md` file (documentation).

## Workflow Index

### Implemented Workflows (1 TOON+MD pair)

1. **[app-navigation.md](./app-navigation.md)** - App launching and screen navigation
...
uv run .claude/skills/adb-workflow-orchestrator/scripts/adb-run-workflow.py \
  --workflow .claude/skills/adb-navigation-base/workflow/{workflow-name}.toon \
