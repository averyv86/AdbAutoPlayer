...
# Agent Factory Orchestration Metadata (v2.0)
...
agent:
  ...
  critical_actions:
    ...
    - "GENERATE TOON YAML agent definition"
  ...
  menu:
    - trigger: create-agent
      ...
      description: "Create new agent with TOON definition"
    ...
    - trigger: convert-to-toon
      action: convert_agent_to_toon
      description: "Convert existing agent to TOON format"
